...
language sql stable security invoker set search_path='' as $$
 with query_input as(select replace(replace(replace(lower(trim(search_query)),'mac and cheese','macaroni & cheese'),'mac & cheese','macaroni & cheese'),'eggs','egg') as normalized)
